...
// a combination of both words, merged at the point where the given
// letter first appears in each word. The returned word should have the beginning
// of the first word and the ending of the second, with the dividing letter in the middle.
